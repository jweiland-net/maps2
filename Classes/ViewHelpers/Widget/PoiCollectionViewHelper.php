...
class PoiCollectionViewHelper extends AbstractWidgetViewHelper {
	 ...
	 * @return void
	 */
	public function injectController(\JWeiland\Maps2\ViewHelpers\Widget\Controller\PoiCollectionController $controller) {
	 ...
	 * @return string
	 */
	public function render(\JWeiland\Maps2\Domain\Model\PoiCollection $poiCollection, $width = 400, $height = 300, array $mapOptions = array()) {
