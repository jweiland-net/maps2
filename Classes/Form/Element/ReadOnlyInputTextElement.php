...
/**
 * This is a copy of TYPO3 core's InputTextElement.
 *
 * We can't make use of TCA property "readOnly = 1" as this will remove all HTML needed to validate, get, set, parse
 * and store the content of the field.
 */
