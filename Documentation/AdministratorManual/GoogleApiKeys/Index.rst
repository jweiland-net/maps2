...
#.  You will get a Done-Message from where you can copy your new API Key and
    ...
    follow the link
    to `API Console <https://console.cloud.google.com/apis/credentials>`_ to
...
Please visit
the `API Console <https://console.cloud.google.com/apis/credentials>`_ again
...
Visit API Console again and go to
your `billing information <https://console.cloud.google.com/billing>`_
